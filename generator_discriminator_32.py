# Generator and Discriminator class for 32 x 32 x 3 images
...
class Generator_32(nn.Module):
    ...
    def __init__(self, n_classes, ngpu, nz = 100, nc = 3, ngf = 32):
        '''
...
class Discriminator_32(nn.Module):
    ...
    def __init__(self, n_classes, ngpu, nc = 3, ndf = 32):
        '''
